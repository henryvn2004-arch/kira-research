...
//   Returns: {
//     success, filename,
//     pdf_base64, pdf_size_bytes, page_count,
//     overflow_detected, overflow_pages, rendered_at
//   }
//
// Auth: shared secret in PDF_RENDER_SECRET env var. Default-deny —
...
export default async function handler(req, res) {
  ...
  // Default-deny: env var MUST be set AND header MUST match.
