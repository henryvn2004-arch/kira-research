...
- [Phase R brainstorm — companies directory](project_r_seo_companies_directory.md) — Henry's SEO long-tail hypothesis ("company name catches more than category name"). Mordor playbook explored: aggregator-style breadth (stock-exchange scrape + Wikipedia enrich) vs niche-depth KIRA analyst layer. Parked 2026-05-27 — Henry thinking more before committing.
