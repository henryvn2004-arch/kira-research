...
diagram    → {"type":"diagram","code":"flowchart LR\n  A[Step1] --> B[Step2] --> C[Step3]","title":"..."}
             DIAGRAM CRITICAL RULES:
             - ONLY use flowchart LR (never timeline, never quadrantChart — they break)
             - Node labels MUST be English/ASCII only (no Vietnamese, no special chars)
             - Max 6 nodes, simple arrows only: A[Label] --> B[Label]
