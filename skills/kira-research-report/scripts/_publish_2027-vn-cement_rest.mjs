// Publish 2027-vn-cement to Supabase via PostgREST (cron fires lack the
...
import { SLUG, COUNTRY, INDUSTRY, YEAR, PAGES, PRICE, META } from './_build_2027-vn-cement_sql.mjs';
