// Fallback publisher for 2027-my-semiconductor when the Supabase MCP transport
// is unavailable. Performs the same two upserts as _build_2027-my-semiconductor_sql.mjs
...
//
// Run: node skills/kira-research-report/scripts/_publish_2027-my-semiconductor_rest.mjs
...
const META = {
  en: {
    ...
    preview: {
      ...
      chart: { title: 'Global chip sales trajectory', subtitle: 'USD bn · worldwide · 2024 → 2026 forecast', bars: chartBars },
    },
    toc: [
  ...
  ja: {
    ...
    preview: {
      ...
      chart: { title: '世界の半導体売上推移', subtitle: '10億USD · 世界 · 2024年 → 2026年予測', bars: chartBars },
    },
    toc: [
  ...
  ko: {
    ...
    preview: {
      ...
      chart: { title: '세계 반도체 매출 추이', subtitle: '10억 USD · 세계 · 2024 → 2026 예측', bars: chartBars },
    },
    toc: [
...
async function main() {
  // Step 1: upsert living_reports, return id
  const lrBody = [{
    slug: SLUG, country: 'Malaysia', industry: 'Manufacturing', year: 2027,
    pages: 23, price: 39, currency: 'USD', status: 'published', published_at: NOW,
  }];
  ...
  // Step 2: upsert 3 report_translations
