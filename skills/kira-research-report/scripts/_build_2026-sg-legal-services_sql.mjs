...
// rows for 2026-sg-legal-services (Singapore legal services 2026).
// Modeled on _build_2027-my-semiconductor_sql.mjs.
// Run: `node skills/kira-research-report/scripts/_build_2026-sg-legal-services_sql.mjs > /tmp/insert_sg_legal.sql`
...
const INDUSTRY = 'Legal Services';
const YEAR     = 2026;
const PAGES    = 14;
const PRICE    = 39;

// Exec chart — SG legal services market sizing, USD bn. 5.05 / 6.17 / 6.82. Max 6.82.
const chartBars = [
...
const META = {
  en: {
    ...
    preview: {
      ...
      chart: {
        title: 'SG legal services market sizing',
        subtitle: 'Singapore · USD bn · 2022–2030F',
        bars: chartBars,
      },
    },
    toc: [
  ...
  ja: {
    ...
    preview: {
      ...
      chart: {
        title: 'SG法律サービス市場規模',
        subtitle: 'シンガポール · USD bn · 2022–2030F',
        bars: chartBars,
      },
    },
    toc: [
  ...
  ko: {
    ...
    preview: {
      ...
      chart: {
        title: 'SG 법률 서비스 시장 규모',
        subtitle: '싱가포르 · USD bn · 2022–2030F',
        bars: chartBars,
      },
    },
    toc: [
