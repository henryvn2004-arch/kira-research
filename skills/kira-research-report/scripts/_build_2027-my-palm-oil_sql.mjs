...
// for 2027-my-palm-oil. Parses each locale HTML for title/lede/paragraphs/toc
...
// simplified 3-bar palm export-value chart from the exec-chart on page 4).
// Run: node skills/kira-research-report/scripts/_build_2027-my-palm-oil_sql.mjs > /tmp/mypalm.sql
import fs from 'node:fs';

const SLUG     = 'malaysia-palm-oil-2027';
const COUNTRY  = 'Malaysia';
const INDUSTRY = 'Palm Oil';
const YEAR     = 2027;
const PAGES    = 12;
const PRICE    = 39;
const DIR      = 'skills/kira-research-report/outputs/batch/2027-my-palm-oil';

// Shared preview chart bars — Malaysia palm export value (RM bn).
// Pulled from the page-4 exec chart: 2024 109.4 / 2025 112.4 / 2027F ~118. Max 118 → pct.
const chartBars = [
  { pct: 93,  label: '2024',  value: 109 },
  { pct: 95,  label: '2025',  value: 112 },
  { pct: 100, label: '2027F', value: 118 },
];

// Per-locale eyebrow + chart title/subtitle (everything else is parsed from HTML).
const FIXED = {
  en: {
    eyebrow: 'MALAYSIA · PALM OIL · MARKET ANALYSIS',
    chart: { title: 'Malaysia palm export value (RM bn)', subtitle: '2024 actual · 2025 actual · 2027 forecast', bars: chartBars },
  },
  ja: {
    eyebrow: 'マレーシア · パーム油 · マーケット分析',
    chart: { title: 'マレーシアのパーム油輸出額(RM 十億)', subtitle: '2024年実績 · 2025年実績 · 2027年予測', bars: chartBars },
  },
  ko: {
    eyebrow: '말레이시아 · 팜유 · 시장 분석',
    chart: { title: '말레이시아 팜유 수출액 (RM 십억)', subtitle: '2024 실적 · 2025 실적 · 2027 예측', bars: chartBars },
  },
};
