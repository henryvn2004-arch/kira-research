...
// rows for 2027-jp-tourism. Run: `node ... > /tmp/insert.sql` then feed to MCP execute_sql.
// pdf_url emits a STORAGE PATH computed inside the SQL CTE. PDFs are .gitignored.
...
// Exec chart — Japan international arrivals (million). Max 60 → pct relative.
const chartBars = [
