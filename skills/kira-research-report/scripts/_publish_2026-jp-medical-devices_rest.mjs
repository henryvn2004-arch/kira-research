// Fallback publisher for 2026-jp-medical-devices when the Supabase MCP transport
// is unavailable (net::ERR_FAILED). Same two upserts as
// _build_2026-jp-medical-devices_sql.mjs (living_reports + 3 report_translations)
// but via PostgREST using SUPABASE_URL + SUPABASE_SERVICE_KEY from env.
//
// Run: node skills/kira-research-report/scripts/_publish_2026-jp-medical-devices_rest.mjs
...
async function main() {
  const lrBody = [{
    slug: SLUG, country: 'Japan', industry: 'Medical Devices', year: 2026,
