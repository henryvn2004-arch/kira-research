// Fallback publisher for 2027-kr-pharma when the Supabase MCP transport
...
//
// Run: node skills/kira-research-report/scripts/_publish_2027-kr-pharma_rest.mjs
...
async function main() {
  const lrBody = [{
    slug: SLUG, country: 'South Korea', industry: 'Pharma', year: 2027,
