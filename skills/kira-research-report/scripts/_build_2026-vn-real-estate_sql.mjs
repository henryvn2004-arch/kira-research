...
// for 2026-vn-real-estate. Parses each locale HTML for title/lede/paragraphs/toc
...
// simplified 3-bar FDI-disbursement chart).
// Run: node skills/kira-research-report/scripts/_build_2026-vn-real-estate_sql.mjs > /tmp/vnre.sql
import fs from 'node:fs';

const SLUG     = 'vietnam-real-estate-2026';
const COUNTRY  = 'Vietnam';
const INDUSTRY = 'Real Estate';
const YEAR     = 2026;
const PAGES    = 29;
const PRICE    = 39;
const DIR      = 'skills/kira-research-report/outputs/batch/2026-vn-real-estate';

// Shared preview chart bars — Vietnam FDI disbursement (USD bn). Max 28.5 → pct.
const chartBars = [
  { pct: 79,  label: '2022',  value: 22.4 },
  { pct: 89,  label: '2024',  value: 25.4 },
  { pct: 100, label: '2026F', value: 28.5 },
];

// Per-locale eyebrow + chart title/subtitle (everything else is parsed from HTML).
const FIXED = {
  en: {
    eyebrow: 'VIETNAM · INDUSTRIAL REAL ESTATE · MARKET ANALYSIS',
    chart: { title: 'Vietnam FDI disbursement (USD bn)', subtitle: '2022 actual · 2024 actual · 2026 forecast', bars: chartBars },
  },
  ja: {
    eyebrow: 'ベトナム · 工業不動産 · マーケット分析',
    chart: { title: 'ベトナムFDI実行額(USD bn)', subtitle: '2022年実績 · 2024年実績 · 2026年予測', bars: chartBars },
  },
  ko: {
    eyebrow: '베트남 · 산업용 부동산 · 시장 분석',
    chart: { title: '베트남 FDI 집행액 (USD bn)', subtitle: '2022 실적 · 2024 실적 · 2026 예측', bars: chartBars },
  },
};
